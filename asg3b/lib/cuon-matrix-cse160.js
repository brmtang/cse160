...
class Vector3 {
    ...
    static dot(other1, other2) {
        ...
        var s = other1.elements;
        var t = other2.elements;
        var m1 = s[0] * t[0];
        var m2 = s[1] * t[1];
        var m3 = s[2] * t[2];
        d = m1 + m2 + m3;
    ...
    static cross(other1, other2) {
        ...
        var s = other1.elements;
        var t = other2.elements;
        var x = (s[1] * t[2]) - (s[2] * t[1]);
        var y = (s[2] * t[0]) - (s[0] * t[2]);
        var z = (s[0] * t[1]) - (s[1] * t[0]);
        console.log("Cross product is: " + x + ", " + y + ", " + z)
        var coords = [x, y, z];
        let v3 = new Vector3(coords); // Modify this line to calculate cross product between other1 and other2.
        // Don't delete the return statement.
        return v3;
    }
